...
; - Bằng cách dùng con trỏ Z cho ZL = nội dung 142H, ZH = nội dung 143H ta thu được 2 byte là địa chỉ bắt đầu của khối dữ liệu
; - Load nội dung của Z là phần tử đầu tiên của khối dữ liệu, gán min_val = phần tử đầu tiên
...
MAIN:       LDS     ZL, 0X142       ; Load nội dung của 142H là byte thấp của địa chỉ bắt đầu
            LDS     ZH, 0X143       ; Byte cao địa chỉ bắt đầu
            LD      MIN_VAL, Z+     ; Load phần tử đầu tiên
...
LAP:        LD      R16, Z+         ; Load phần tử tiếp và tăng Z lên 1
            ...
            RJMP    STORE
UPDATE:     CLR     MIN_VAL         ; Clear MIN_VAL hiện tại
            MOV     MIN_VAL, R16    ; Di chuyển R16 vào MIN_VAL
            RJMP    LAP
